...
public class ControleCadastro {
     ...
     * passadas como parâmetro; será realizada uma busca no banco de dados para
     * saber se existe um usuário com o username e email que foi passado como
     * parâmetro.
     *
    ...
    public String receberInformacao(String username, String email) {
        try {
            ...
            if (this.verificarUsuario(username) == true) {
                /**
                 * Verifica se já existe um username de um usuario igual o valor
                 * do parâmetro username no sistema; Se retornar a true,
                 * entende-se que o username ja existe; o método retorna um
                 * valor para ser mostrada uma mensagem na tela.
                 */
                return "usuario";
            } else if (this.verificarEmail(email) == true) {
                /**
                 * Verifica se já existe um usuário com nome de usuário igual o
                 * valor do parâmetro username no sistema; Se retornar a
                 * true,entende-se que o e-mail ja foi cadastrado o método
                 * retorna um valor para ser mostrada uma mensagem na tela.
                 */
                return "email";
            } else {
                /**
     ...
     *
     * @param username Username do suposto novo usuário.
     * @return boolean: se username está sendo utilizado retorna <b>true</b>, se
     * não retorna a <b>false</b>.
     */
     ...
     *
     * @param email E-mail do suposto novo usuário.
     * @return boolean: se email está sendo utilizado retorna <b>true</b>, se
     * não retorna a <b>false</b>.
     */
